    ...
    <Container className="mt-3 mb-3 p-5 sfondoVendita">
        ...
        <Col xs={12} md={6}>
          ...
          <div className="d-flex flex-column justify-content-center">
            <div class="form-floating mb-4">
              <input type="text" className="form-control login" id="floatingInput" placeholder="Tipo di prodotto*" />
              <label for="floatingInput" className="fst-italic d-flex align-items-center justify-content-center">
                Tipo di prodotto*
              </label>
            </div>
            <div className="form-floating mb-4">
              <input type="text" className="form-control login" id="floatingInput" placeholder="Quantità in kg*" />
              <label for="floatingPassword" className="fst-italic d-flex align-items-center justify-content-center">
                Quantità in kg*
              </label>
            </div>
            <div className="form-floating mb-4">
              <input type="text" className="form-control login" id="floatingInput" placeholder="Prezzo*" />
              <label for="floatingPassword" className="fst-italic d-flex align-items-center justify-content-center">
                Prezzo*
              </label>
            </div>
      ...
      <Row>
        <div className="d-flex justify-content-center">
          <Button variant="success" className="bottoneLogin mb-5">
            Vendi prodotto
          </Button>
        </div>
      </Row>
